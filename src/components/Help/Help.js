							...
							<main className="pa4 black-80">
							  <div className="measure">
							    <fieldset id="help" className="ba b--transparent ph0 mh0">
							      ...
							      <div className="mt3">
								  <button onClick={this.toggleFaqPopup.bind(this)}>FAQ</button>
							      </div>
							      <div className="mv3">
								  	<button onClick={this.toggleTechPopup.bind(this)}>Technical Help</button>
									  </div>
									<div className="mv3">
									<button onClick={this.toggleTermsPopup.bind(this)}>Read Terms Policy</button>
							      </div>
								  <div>
